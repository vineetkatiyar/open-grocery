...
const OrderSuccessfull = ({ orderid, message, redirecto }) => {
  ...
  const [orderdata, setorderdata] = useState({
    ...
    CustomerName: "Vineet katiyar",
    CustomerShipToAddress:
      "B-101 Nighasan Near Tehsil Nighasan pin-262903",
    CustomerEmail: "vineetkatiyar98@gmail.com",
    OrderItems: [
      {
