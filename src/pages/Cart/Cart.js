...
import ptm from '../../assets/images/ptm.png'
import ppe from '../../assets/images/ppe.png'
import gpe from '../../assets/images/gpe.jpg'
...
const Cart = () => {
  ...
  return (
    <div>
      ...
      {
        ordersuccesscont && <OrderSuccessfull orderid={selectedorderid} message={`Order Placed Successfully, Order ID: ${selectedorderid}`}  redirecto='userorders'/>
      }
      <div className='cart'>
